...
*/
    .gas[0].bottle_id_bar = 0,
    .gas[1].bottle_id_bar = 0,
    .gas[2].bottle_id_bar = 0,
    .gas[3].bottle_id_bar = 0,
    .gas[4].bottle_id_bar = 0,
    .gas[5].bottle_id_bar = 0,
    .gas[6].bottle_id_bar = 0,
    .gas[7].bottle_id_bar = 0,
    .gas[8].bottle_id_bar = 0,
    .gas[9].bottle_id_bar = 0,
    .gas[10].bottle_id_bar = 0,
