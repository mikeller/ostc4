...
static uint8_t text_EN_Tempstick[] = "Tempstick";
static uint8_t text_DE_Tempstick[] = "";
static uint8_t text_FR_Tempstick[] = "";
static uint8_t text_IT_Tempstick[] = "";
static uint8_t text_ES_Tempstick[] = "";
...
const tText text_array2[] =
{
	...
	{(uint8_t)TXT2BYTE_Tempstick, 		{text_EN_Tempstick, text_DE_Tempstick, text_FR_Tempstick, text_IT_Tempstick, text_ES_Tempstick}},
