...
src/base_upperRegion.o: $(BUILD_DIR)/FontPack/base_upperRegion.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -DBUILD_LIBRARY -DSTM32 -DSTM32F4 -DSTM32F429IITx -I"$(BUILD_DIR)/Discovery/Inc" -I"$(BUILD_DIR)/Common/Inc" -Os -Wall -ffunction-sections -fdata-sections -fmessage-length=0 -u symbol -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
